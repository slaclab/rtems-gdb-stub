...
\date{3/14/2005; last modified 6/2/3005\\
\nix
}
...
\item
  ...
  you have to remove the respective {\tt DEFINES} in the
  {\tt Makefile}.
\end{itemize}
...
\subsubsection*{Path Settings}
	...
	changed from within a GDB session (GDB's \cmd{environ} ans \cmd{path}
